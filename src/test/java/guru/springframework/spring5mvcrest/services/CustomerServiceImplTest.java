...
public class CustomerServiceImplTest {
    ...
    public void setUp() throws Exception {
        ...
        customerService = new CustomerServiceImpl(customerRespository,customerMapper);
    }
    ...
    public void getAllCustomers() throws Exception {
        ...
        when(customerRespository.findAll()).thenReturn(Arrays.asList(customer1,customer2));
    ...
    public void getCustomerById() throws Exception {
        ...
        when(customerRespository.findById(anyLong())).thenReturn(Optional.ofNullable(customer1));
